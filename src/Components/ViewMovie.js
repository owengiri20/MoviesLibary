...
import { genres, getGenres, getGenresObj } from "../Helpers/genres";
import API_KEY from '../Helpers/key';
import CastCaruosel from './CastCaruosel';
        ...
        this.getMovie(id)
            .then(movie => {
                movieOutput = {
                    ...
                    movieGenre: getGenresObj(movie.genres),
                ...
                console.log("movieToDisPlay", this.state.movieToDisplay);
        ...
        if (this.state.movieToDisplay !== "") {
            ...
            return (
                <div>
                    ...
                    <CastCaruosel movieId={this.props.match.params.id} />
                </div>
